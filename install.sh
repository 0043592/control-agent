...
sudo apt update && sudo apt install --no-install-recommends --no-install-suggests -y make apt-transport-https ca-certificates curl gnupg lsb-release && apt autoremove --purge -y apache2 nginx
